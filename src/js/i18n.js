...
const I18N = {
  zh: {
    ...
    pdfPasswordTitle: 'PDF 需要密码',
    pdfPasswordPrompt: '请输入 PDF 密码',
    pdfPasswordWrong: '密码错误，请重试',
    pdfPasswordHint: '此 PDF 已加密，需要密码才能预览',
    pdfPasswordCancelled: '已取消输入密码',
    pdfLoadFailed: 'PDF 加载失败',
    pdfTooLarge: 'PDF 文件过大（超过 50MB），请下载后查看',
    pdfLoadingDownload: '正在下载 PDF…',
    pdfLoadingParse: '正在解析 PDF…',
    pdfLoadingSize: '{loaded} / {total} · {pct}%',
    fullscreen: '全屏',
    exitFullscreen: '退出全屏',
    size: '大小',
    lastModified: '最后修改',
  ...
  zh_TW: {
    ...
    pdfPasswordTitle: 'PDF 需要密碼',
    pdfPasswordPrompt: '請輸入 PDF 密碼',
    pdfPasswordWrong: '密碼錯誤，請重試',
    pdfPasswordHint: '此 PDF 已加密，需要密碼才能預覽',
    pdfPasswordCancelled: '已取消輸入密碼',
    pdfLoadFailed: 'PDF 載入失敗',
    pdfTooLarge: 'PDF 檔案過大（超過 50MB），請下載後查看',
    pdfLoadingDownload: '正在下載 PDF…',
    pdfLoadingParse: '正在解析 PDF…',
    pdfLoadingSize: '{loaded} / {total} · {pct}%',
    fullscreen: '全螢幕',
  ...
  en: {
    ...
    pdfPasswordTitle: 'PDF Password Required',
    pdfPasswordPrompt: 'Enter PDF password',
    pdfPasswordWrong: 'Incorrect password, try again',
    pdfPasswordHint: 'This PDF is encrypted and requires a password to preview',
    pdfPasswordCancelled: 'Password entry cancelled',
    pdfLoadFailed: 'Failed to load PDF',
    pdfTooLarge: 'PDF is too large (over 50MB), please download to view',
    pdfLoadingDownload: 'Downloading PDF…',
    pdfLoadingParse: 'Parsing PDF…',
    pdfLoadingSize: '{loaded} / {total} · {pct}%',
  ...
  ja: {
    ...
    pdfPasswordTitle: 'PDF パスワードが必要です',
    pdfPasswordPrompt: 'PDF パスワードを入力',
    pdfPasswordWrong: 'パスワードが正しくありません',
    pdfPasswordHint: 'この PDF は暗号化されています。プレビューにはパスワードが必要です',
    pdfPasswordCancelled: 'パスワード入力がキャンセルされました',
    pdfLoadFailed: 'PDF の読み込みに失敗しました',
    pdfTooLarge: 'PDF が大きすぎます（50MB 超）。ダウンロードしてご覧ください',
    pdfLoadingDownload: 'PDF をダウンロード中…',
    pdfLoadingParse: 'PDF を解析中…',
    pdfLoadingSize: '{loaded} / {total} · {pct}%',
    fullscreen: '全画面',
